  ...
  love: {
    list: (function generateLoveList() {
      ...
      var words = (
        ...
        "Kärlek,Pag-ibig,காதல்,ప్రేమ,ความรัก,Ишқ,Aşk,محبت,Tình yêu,Higugma,ליבע"
      ).split(",");
    ...
    if ($options.val()) {
      options = (function evalOptions() {
        try {
          ...
          alert(
            "The following Javascript error occurred in the option definition; all option will be ignored: \n\n" +
              error.toString(),
          );
          return {};
        }
